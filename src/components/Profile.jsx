    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-4xl font-bold text-dark-blue mb-2">PROFILE</h1>
          <div className="w-64 h-1 bg-accent-orange mx-auto rounded"></div>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          <p className="text-xl text-gray-700 mb-6">
            Profile page coming soon! This will show your personal information and allow you to update your details.
          </p>
          <button
